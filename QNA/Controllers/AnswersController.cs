...
namespace QNA.Controllers
{
    ...
    public class AnswersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AnswerId,QuestionId,AnswerText,AnswerDateAndTime,name,UpVote,DownVote")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AnswerId,QuestionId,AnswerText,AnswerDateAndTime,name,UpVote,DownVote")] Answer answer)
        {
